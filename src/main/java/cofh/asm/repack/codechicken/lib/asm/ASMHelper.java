...
public class ASMHelper {
	...
	public static Logger logger = LogManager.getLogger("CoFH Repacked:CCL ASM");
	...
	public static void dump(Acceptor acceptor, File file, boolean filterImportant, boolean sortLocals) {
		...
		dump(acceptor, file, filterImportant, sortLocals, Boolean.parseBoolean(System.getProperty("cofh.asm.ccl.textify", "true")));
	}
