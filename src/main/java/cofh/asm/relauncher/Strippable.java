 ...
 * <p>
 * Takes a class name as the value. e.g., "cofh.lib.network.ByteBufHelper" <br>
 * Can also strip on modid using e.g., "mod:CoFHCore" as a value <br>
 * Can also strip on API using e.g., "api:CoFHAPI|energy" as a value
 */
@Documented
