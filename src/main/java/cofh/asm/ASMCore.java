...
mv.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/util/AxisAlignedBB", "copy", "()Lnet/minecraft/util/AxisAlignedBB;");
mv.visitVarInsn(ASTORE, 19);
Label l27 = new Label();
mv.visitLabel(l27);
mv.visitLineNumber(617, l27);
mv.visitVarInsn(ALOAD, 0);
mv.visitFieldInsn(GETFIELD, "net/minecraft/entity/Entity", "onGround", "Z");
Label l28 = new Label();
mv.visitJumpInsn(IFEQ, l28);
mv.visitVarInsn(ALOAD, 0);
mv.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/entity/Entity", "isSneaking", "()Z");
mv.visitJumpInsn(IFEQ, l28);
mv.visitVarInsn(ALOAD, 0);
...
mv.visitLabel(l28);
mv.visitFrame(Opcodes.F_FULL, 11, new Object[] {"net/minecraft/entity/Entity", Opcodes.DOUBLE, Opcodes.DOUBLE, Opcodes.DOUBLE, Opcodes.DOUBLE, Opcodes.DOUBLE, Opcodes.DOUBLE, Opcodes.DOUBLE, Opcodes.DOUBLE, Opcodes.DOUBLE, "net/minecraft/util/AxisAlignedBB"}, 0, new Object[] {});
...
Label l30 = new Label();
mv.visitLabel(l30);
mv.visitLineNumber(619, l30);
mv.visitVarInsn(ILOAD, 20);
Label l31 = new Label();
mv.visitJumpInsn(IFEQ, l31);
Label l32 = new Label();
mv.visitLabel(l32);
mv.visitLineNumber(623, l32);
...
Label l35 = new Label();
mv.visitLabel(l35);
mv.visitLineNumber(625, l35);
mv.visitFrame(Opcodes.F_APPEND,2, new Object[] {Opcodes.INTEGER, Opcodes.DOUBLE}, 0, null);
mv.visitVarInsn(DLOAD, 1);
mv.visitVarInsn(DLOAD, 21);
mv.visitInsn(DCMPG);
Label l36 = new Label();
mv.visitJumpInsn(IFGE, l36);
mv.visitVarInsn(DLOAD, 1);
mv.visitVarInsn(DLOAD, 21);
mv.visitInsn(DNEG);
mv.visitInsn(DCMPL);
mv.visitJumpInsn(IFLT, l36);
Label l37 = new Label();
mv.visitLabel(l37);
mv.visitLineNumber(627, l37);
...
mv.visitLabel(l36);
mv.visitLineNumber(629, l36);
mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
mv.visitVarInsn(DLOAD, 1);
mv.visitInsn(DCONST_0);
mv.visitInsn(DCMPL);
Label l40 = new Label();
mv.visitJumpInsn(IFLE, l40);
Label l41 = new Label();
mv.visitLabel(l41);
...
mv.visitFieldInsn(GETFIELD, "net/minecraft/entity/Entity", "boundingBox", "Lnet/minecraft/util/AxisAlignedBB;");
mv.visitVarInsn(DLOAD, 1);
mv.visitLdcInsn(new Double("-0.9375"));
mv.visitInsn(DCONST_0);
...
mv.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/world/World", "getCollidingBoundingBoxes", "(Lnet/minecraft/entity/Entity;Lnet/minecraft/util/AxisAlignedBB;)Ljava/util/List;");
mv.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "isEmpty", "()Z");
mv.visitJumpInsn(IFNE, l35);
Label l44 = new Label();
mv.visitLabel(l44);
mv.visitLineNumber(639, l44);
mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
mv.visitJumpInsn(GOTO, l43);
Label l45 = new Label();
mv.visitLabel(l45);
mv.visitLineNumber(641, l45);
mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
mv.visitInsn(DNEG);
mv.visitInsn(DCMPL);
mv.visitJumpInsn(IFLT, l46);
Label l47 = new Label();
mv.visitLabel(l47);
mv.visitLineNumber(643, l47);
mv.visitInsn(DCONST_0);
mv.visitVarInsn(DSTORE, 5);
Label l48 = new Label();
mv.visitLabel(l48);
mv.visitLineNumber(644, l48);
Label l49 = new Label();
mv.visitJumpInsn(GOTO, l49);
mv.visitLabel(l46);
mv.visitLineNumber(645, l46);
mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
mv.visitVarInsn(DLOAD, 5);
mv.visitInsn(DCONST_0);
mv.visitInsn(DCMPL);
...
Label l52 = new Label();
mv.visitLabel(l52);
mv.visitLineNumber(648, l52);
mv.visitJumpInsn(GOTO, l49);
mv.visitLabel(l50);
mv.visitLineNumber(651, l50);
mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
mv.visitVarInsn(DLOAD, 5);
mv.visitVarInsn(DLOAD, 21);
mv.visitInsn(DADD);
...
Label l54 = new Label();
mv.visitLabel(l54);
mv.visitLineNumber(655, l54);
mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
mv.visitJumpInsn(GOTO, l53);
Label l55 = new Label();
mv.visitLabel(l55);
mv.visitLineNumber(657, l55);
mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
mv.visitVarInsn(DLOAD, 1);
mv.visitVarInsn(DLOAD, 21);
mv.visitInsn(DCMPG);
Label l56 = new Label();
mv.visitJumpInsn(IFGE, l56);
mv.visitVarInsn(DLOAD, 1);
mv.visitVarInsn(DLOAD, 21);
mv.visitInsn(DNEG);
mv.visitInsn(DCMPL);
mv.visitJumpInsn(IFLT, l56);
Label l57 = new Label();
mv.visitLabel(l57);
mv.visitLineNumber(659, l57);
mv.visitInsn(DCONST_0);
mv.visitVarInsn(DSTORE, 1);
Label l58 = new Label();
mv.visitLabel(l58);
mv.visitLineNumber(660, l58);
Label l59 = new Label();
mv.visitJumpInsn(GOTO, l59);
mv.visitLabel(l56);
mv.visitLineNumber(661, l56);
mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
mv.visitVarInsn(DLOAD, 1);
mv.visitInsn(DCONST_0);
mv.visitInsn(DCMPL);
Label l60 = new Label();
mv.visitJumpInsn(IFLE, l60);
Label l61 = new Label();
mv.visitLabel(l61);
mv.visitLineNumber(663, l61);
mv.visitVarInsn(DLOAD, 1);
mv.visitVarInsn(DLOAD, 21);
mv.visitInsn(DSUB);
mv.visitVarInsn(DSTORE, 1);
Label l62 = new Label();
mv.visitLabel(l62);
mv.visitLineNumber(664, l62);
mv.visitJumpInsn(GOTO, l59);
mv.visitLabel(l60);
mv.visitLineNumber(667, l60);
mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
mv.visitVarInsn(DLOAD, 1);
mv.visitVarInsn(DLOAD, 21);
mv.visitInsn(DADD);
mv.visitVarInsn(DSTORE, 1);
mv.visitLabel(l59);
mv.visitLineNumber(670, l59);
mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
mv.visitVarInsn(DLOAD, 5);
mv.visitVarInsn(DLOAD, 21);
mv.visitInsn(DCMPG);
Label l63 = new Label();
mv.visitJumpInsn(IFGE, l63);
mv.visitVarInsn(DLOAD, 5);
mv.visitVarInsn(DLOAD, 21);
mv.visitInsn(DNEG);
mv.visitInsn(DCMPL);
mv.visitJumpInsn(IFLT, l63);
Label l64 = new Label();
mv.visitLabel(l64);
mv.visitLineNumber(672, l64);
mv.visitInsn(DCONST_0);
mv.visitVarInsn(DSTORE, 5);
Label l65 = new Label();
mv.visitLabel(l65);
...
Label l69 = new Label();
mv.visitLabel(l69);
mv.visitLineNumber(677, l69);
mv.visitJumpInsn(GOTO, l66);
mv.visitLabel(l67);
mv.visitLineNumber(680, l67);
mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
mv.visitVarInsn(DLOAD, 5);
mv.visitVarInsn(DLOAD, 21);
mv.visitInsn(DADD);
mv.visitVarInsn(DSTORE, 5);
mv.visitLabel(l66);
mv.visitLineNumber(683, l66);
mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
mv.visitVarInsn(DLOAD, 1);
mv.visitVarInsn(DSTORE, 13);
Label l70 = new Label();
mv.visitLabel(l70);
mv.visitLineNumber(684, l70);
mv.visitVarInsn(DLOAD, 5);
mv.visitVarInsn(DSTORE, 17);
mv.visitLabel(l53);
