...
public class FontRendererCoFH extends FontRenderer {

	public FontRendererCoFH(GameSettings gameSettings, ResourceLocation resourceLocation, TextureManager textureManager, boolean unicode) {

		super(gameSettings, resourceLocation, textureManager, unicode);
	}
