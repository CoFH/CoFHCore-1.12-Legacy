...
public class RenderPlayerFace implements ICustomCharRenderer {
	...
	public static char init(FontRendererCoFH render) {
	...
	public static FontRendererCoFH loadProfile(ItemStack item) {
	...
	private static FontRendererCoFH setProfile(GameProfile gameProfile) {
