...
public class Matrix4 extends Transformation implements Copyable<Matrix4> {
	...
	public Matrix4(double d00, double d01, double d02, double d03, double d10, double d11, double d12, double d13, double d20, double d21, double d22,
			double d23, double d30, double d31, double d32, double d33) {
