...
public abstract class ITransformation<Vector, Transformation extends ITransformation> {
	...
	/**
	 * @param point
	 *            The point to apply this transformation around
	...
	/**
	 * Creates a TransformationList composed of this transformation followed by t If this is a TransformationList, the transformation will be appended and this
	 * returned
	 */
